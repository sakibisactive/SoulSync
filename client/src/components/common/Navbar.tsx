...
import { Heart, Sparkles, User, MessageSquare, Shield, LogOut, Compass, Bookmark } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <Link to="/" className="flex items-center gap-2 group">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-tr from-indigo-600 via-rose-500 to-amber-400 p-0.5 shadow-lg shadow-rose-500/20 group-hover:scale-105 transition-transform">
          ...
          {isAuthenticated ? (
            <div className="flex items-center gap-1 sm:gap-4">
              ...
              >
                ...
                <span className="hidden md:inline">Saved & Likes</span>
              </Link>
